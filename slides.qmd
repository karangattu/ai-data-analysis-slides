...
::: {.fragment}
{{< fa building >}} **Organizational Data**
- Grant proposals, budgets, donor information
- Unpublished research findings
:::

::: {.fragment}
{{< fa location-dot >}} **Sensitive Location Data**
- Exact nesting sites of endangered species
:::

::: {.fragment}
{{< fa user-secret >}} **Personal Information**
- Volunteer contact details
- Observer full names in survey data
:::
